...
mDLL = cdll.LoadLibrary('C:/Users/ING46/Documents/workspace/DNSDLL_System/DNSDLL_System/DLL/API/lib/x64/release/Qt/DoricSystem.dll')
...
def main():
    ...
    # Example_RotaryJoint_Get_Detectors_State(mDLL, ROTARY_JOINT_USB_PORT_NUMBER, 50, 1000)
    Example_RotaryJoint_Get_Motor_Angle(mDLL, ROTARY_JOINT_USB_PORT_NUMBER, 50, 1000)
