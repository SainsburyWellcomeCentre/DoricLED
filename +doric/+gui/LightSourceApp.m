    ...
    methods (Access = private)
        ...
        function buildMain(obj)
            ...
            for k = 1:2
                ...
                c.Slider(k) = uislider(row, 'Limits', [0 2000], 'MajorTicks', [], ...
                    'MinorTicks', [], ...
                ...
                c.Intensity(k) = uieditfield(row, 'numeric', 'Limits', [0 65535], ...
                    'ValueDisplayFormat', '%.0f', ...
                    'ValueChangedFcn', @(src, ~) obj.onIntensity(k, src.Value), ...
                    'Tooltip', 'Intensity in mA (integer)');
                uilabel(row, 'Text', 'mA');
        ...
        function t = buildChannelTab(obj, tab, k)
            ...
            t.CurrentMode = uidropdown(g, 'Items', cellstr(string(enumeration('doric.CurrentMode'))), ...
                ...
                'Tooltip', 'Normal, LowPower or Overdrive current range (currentMode)');
        ...
        function t = buildLimitsTab(obj, tab)
            ...
            for k = 1:2
                ...
                t.MaxCurrent(k) = uieditfield(g, 'numeric', 'ValueDisplayFormat', '%.0f', ...
                    ...
                    'Tooltip', ['Requests above this limit are refused, never reduced. ' ...
                    'Check the LED and preparation before raising it.']);
                uilabel(g, 'Text', '');
            end
